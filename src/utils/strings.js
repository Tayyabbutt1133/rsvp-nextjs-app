export const strings = {
    title: "Special Events RSVP",
    description: "We're excited to celebrate our Special event with you! Please let us know if you can make it.",
    eventDate: "2024-06-15", // YYYY-MM-DD format
    eventDateLabel: "Event Date",
    eventLocation: "Silicon Valley, San Francisco Bay Area",
